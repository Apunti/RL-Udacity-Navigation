...
This project consists on training an agent to navigate (and collect bananas!) in a large, square world.  
...
```
git clone https://github.com/Apunti/RL-Udacity-Navigation.git
```
...
Follow the instructions in `Navigation.ipynb` to get started with training your own agent! Go to the part 4. It's Your Turn and run the cells.
